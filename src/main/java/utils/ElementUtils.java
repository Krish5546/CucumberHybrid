...
public class ElementUtils {
    ...
    // NEW: wait for element located by By
    public WebElement waitForElement(By locator,long durationInSeconds) {
        WebElement webElement = null;
        try {
            WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(durationInSeconds));
    ...
    // NEW: wait for visibility using By
    public WebElement waitForVisibilityOfElement(By locator,long durationInSeconds) {
        WebElement webElement = null;
        try {
            WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(durationInSeconds));
